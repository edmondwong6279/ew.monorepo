      ...
      >
        <NavBar
          navItems={[
            ...
            { title: "Background", link: "/background", active: false },
            { title: "Proficiences", link: "/proficiences", active: false },
            { title: "Projects", link: "/projects", active: false },
            { title: "Blog", link: "/blog", active: false },
          ]}
        />
        ...
        <div className="absolute h-full w-full pointer-events-none">
          <div className="sticky top-0 bottom-0 h-screen overflow-hidden -z-10">
            ...
            <div className="absolute z-[-20] right-[0] md:right-[9%] top-[30%] w-[160px] h-[160px] md:w-[295px] md:h-[280px] rounded-full animate-spin-slow bg-gradient-to-b from-[#D37373] to-[#2F14D7] blur-[55.7px] transform-[matrix(0.45, 0.89, -0.9, 0.43, 0, 0)]" />
