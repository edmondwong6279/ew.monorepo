      ...
      >
        ...
        <div className="absolute h-full w-full pointer-events-none">
          <div className="sticky top-0 bottom-0 h-screen overflow-hidden -z-10">
            ...
            <div className="absolute z-[-20] right-[0] md:right-[calc(50%-500px)] top-[30%] w-[280px] h-[280px] md:w-[295px] md:h-[280px] rounded-full animate-spin-slow bg-gradient-to-b from-[#D37373] to-[#2F14D7] blur-[55.7px] transform-[matrix(0.45, 0.89, -0.9, 0.43, 0, 0)]" />
